...
export function CharacterScriptPanel({ lines, characters, busy, currentLine, canSpeak, onChange, onSpeak, onStop }: Props) {
  ...
  return (
    <Panel title="台本">
      ...
      {currentLine !== null && <p className="script-status" aria-live="polite">いま {currentLine + 1} 行目を読んでいます</p>}
    </Panel>
  );
}
